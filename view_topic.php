...
<tr>
<td><table width="100%" cellpadding="3" border="0" cellspacing="1" bordercolor="1">
<tr>
...
<tr>
<td ><strong>By :</strong> <?php echo $rows['member_name']; ?><strong></td>
</tr>
...
<td width="5%" >:</td>
<td width="77%"><?php echo $rows['member_name']; ?></td>
</tr>
<tr>
...
<td valign="top">:</td>
<td ><textarea name="response" id="answer" style="border: none; width: 100%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;"></textarea></td>
</tr>
<tr>
<td>&nbsp;</td>
